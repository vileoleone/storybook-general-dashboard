  ...
  <div type="span" class="step-section" :class="classes" @click="onClick" :style="style">
    ...
    <div class="step-div">
      <div v-for="(subtext, label, index) in dict" :key="index" class="step-div">
        <LeftSectionItem :label="label" :index="index" :subtext="subtext" :step="step" />
      </div>
    </div>
  </div>
</template>
...
<script>
import LeftSectionItem from '#/Sections/QueueConfigComponents/LeftSectionSteps/LeftSectionItem.vue'
export default {
