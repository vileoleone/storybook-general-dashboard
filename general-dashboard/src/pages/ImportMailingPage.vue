<template>
    <div type="span" class="mailing-page" :class="classes" @click="onClick" :style="style">
      ...
      <div v-if="step == 1" class="import-sections">
        ...
        <MailingMainSection label ="Arquivo" :queues ="queueList" :vueComponent ="QueueStep"/>
      </div>
  ...
  export default {
    ...
    components: { HeaderComponent, NextSection, StepSection, MailingMainSection},

    data() {
      return {
        QueueStep,
        nextSectionList: ['Dashboards', 'Campanhas', 'Importação'],
        stepSectionDict : {'Fila':'Nome da fila escolhida', 'Arquivo': 'nome_do_arquivo.csv', 'Mapeamento do Arquivo': '1234 registros - 6 colunas', 'Mapeamento do perfilador': '6 colunas em campo', 'Análise dos campos do arquivo': '3 colunas ignoradas', 'Importação': '' },
